                                    ...
                                    <div className='font-agradir font-size-15'>
                                            <Row>
                                                ...
                                                <Col md={9}>
                                                    ...
                                                    <p className='text-align-left secondary-font-color margin-top-20 font-size-15'>The latest we can accept is on <span className= "font-weight-bold ">December 8 to December 18, 2024 </span>. If we will not receive a response by this date, it will marked as "NO".</p>
